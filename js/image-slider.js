var ImageSlider = (function() {
	...
	var Slider = function(args) {
		...
		this.settings = {
			selector: '',
			height: 585, // Required but can be set by CSS
			interval: 4000,
		...
		var origChildren = _toArray(sliderEl.children),
			validSlides = [];
		sliderEl.innerHTML = '';
		Array.prototype.forEach.call(origChildren, function(slide){
		...
		if(slides.length <= 1){
			sliderEl.innerHTML = '';
			Array.prototype.forEach.call(origChildren, function(child){
		...
		Array.prototype.forEach.call(this._attributes.slides, function(slide){
	...
	Slider.prototype.destroy = function() {
		...
		Array.prototype.forEach.call(this._attributes.origChildren, function(child){
